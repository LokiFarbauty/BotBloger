...
Отображения (views)
    Telegram
        ...
        от BotViewInterface (interface_pattern.py). Имя стартового диалога можно указать в переменной start_dialog.
        Но первое состояние (State) запускаемого диалога всегда должно называть "start".
